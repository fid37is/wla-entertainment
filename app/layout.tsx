...
export default function RootLayout({
  ...
  return (
    <html lang="en-NG" suppressHydrationWarning>
      <head>
        <meta name="facebook-domain-verification" content="fn47xeot403z5y5bzhqjpckj5s2zb6" />
        <link rel="preconnect" href="https://fonts.googleapis.com" />
        <link rel="preconnect" href="https://fonts.gstatic.com" crossOrigin="anonymous" />
        <link
          href="https://fonts.googleapis.com/css2?family=Big+Shoulders+Display:wght@600;700;800;900&family=Inter:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;500;600;700&display=swap"
          rel="stylesheet"
        />
      </head>
